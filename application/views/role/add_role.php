       ...
       <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span id="rolePopupTitle" name="rolePopupTitle">Add Role</span></h4>
            </div>
            ...
            <input class="form-control" id="role_id" name="role_id" type="hidden" value="" />
                 <input id="btn_login" name="btn_login" type="submit" class="btn btn-default" value="Submit" onclick="manageRole()"/>
