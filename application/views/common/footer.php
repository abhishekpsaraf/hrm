...
<script src="<?php echo base_url(); ?>assets/js/role.js"></script>
<script src="<?php echo base_url(); ?>assets/js/leaves.js"></script> 
<script src="<?php echo base_url(); ?>assets/js/leavesAngular.js"></script>
<!-- jQuery 2.2.3 -->
